    ...
    delegate("body", {
        ...
        onShow(instance) {
            ...
            $popper.one("click", ".popover_mute_topic", (e) => {
                muting_ui.mute_topic(message.stream_id, message.topic);
                e.preventDefault();
            });

            $popper.one("click", ".popover_unmute_topic", (e) => {
                muting_ui.unmute_topic(message.stream_id, message.topic);
                e.preventDefault();
            });

            popovers.clipboard_enable(".copy_link").on("success", (e) => {
